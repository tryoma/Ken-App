...
export const contents: Content[] = [
  {
    ...
    emailBody:
      '『【依頼者の名前】』さんからのアドバイス依頼が届いています。アドバイス依頼を確認しましょう。',
  },
  {
    ...
    emailSubject: '【Ken-App】からのお知らせ',
    emailBody:
      '『【トレーナーの名前】』さんからアドバイス依頼が回答されました。回答を確認しましょう。',
  },
  {
    announceType: 'adviceRequestCanceledToUser',
    fcmTitle: '【Ken-App】からのお知らせ',
    fcmBody:
      '『【トレーナーの名前】』さんへのアドバイス依頼がキャンセルされました',
    fcmClickAction:
      'https://dev.ken-app.com/private/general/dashboard/advice-requests',
    emailSubject: '【Ken-App】からのお知らせ',
    emailBody:
      '期限内にアドバイス依頼が回答されなかったため、『【トレーナーの名前】』さんへのアドバイス依頼がキャンセルされました。使用したポイントの【ポイント】Pは返却されています。',
  },
  {
    announceType: 'adviceRequestCanceledToTrainer',
    fcmTitle: '【Ken-App】からのお知らせ',
    fcmBody:
      '『【依頼者の名前】』さんからのアドバイス依頼がキャンセルされました',
    fcmClickAction:
      'https://dev.ken-app.com/private/general/dashboard/advice-requests',
    emailSubject: '【Ken-App】からのお知らせ',
    emailBody:
      '期限内にアドバイス依頼が回答されなかったため、『【依頼者の名前】』さんからのアドバイス依頼がキャンセルされました。',
  },
];
